...
console.log(final)
    currentPrice.innerHTML = "Current USD : <span>&dollar; "+final+"</span> /gram"

button.addEventListener('click', () => {
    let calculatedPrice = parseFloat(gram.value)*final;
    let userRequiredPrice = calculatedPrice.toFixed(2);
    document.querySelector("#finalPrice").innerHTML = "Price will be <span>&dollar; " + userRequiredPrice+"</span>"
})
})
